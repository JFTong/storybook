...
import { Plus, Trash2, Edit2, Sparkles, RefreshCw } from "lucide-react";
  ...
  const handleGenerateImage = async () => {
    ...
    try {
      ...
      if (data.imageUrl) {
        ...
        setReferenceImage(data.imageUrl); // Also set as reference image
      } else {
              ...
              >
                {isGeneratingImage ? (
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    {!apiKey && (
                      <p className="text-xs text-destructive">API key required</p>
                    )}
                  </div>
                )}
              </div>
